...
import { singleBus } from "../../redux/slices/SingleBus";
import maintanence from '../../assets/maintanence.png'

const SeatLayout = () => {
  const singleBuses = useSelector(singleBus);

  if (!singleBuses || !singleBuses.seatLayout) {
    return (
      <>
        <div className="text-center bg-white p-5 ">...Loading...</div>
      </>
    );
  }
  ...
  return (
    <div className="container p-2">
      <div className="container seatlayout">
        <div className="row bg-white p-3 align-items-center">
          <h3>{singleBuses.name}</h3>
          <div className="col-md-1"></div>
          <div className="col-md-4 p-4 bus my-5">
            ...
            <div className="row justify-content-between align-items-center">
              {Object.keys(singleBuses.seatLayout).map((level) => (
                <div className="col-md-6 d-flex justify-content-center p-0" key={level}>
                  {singleBuses.seatLayout[level].map((row, rowIndex) => (
                    <div className="col-md-5" key={rowIndex}>
                      {row.map((seat) => (
                        <span key={seat}>
                          <svg
                            width="37"
          ...
          <div className="col-md-5  my-5">
            <h5 className="text-center">Development in Progress</h5>
            <img
              src={maintanence}
              className="img-fluid"
              alt="maintanence"
